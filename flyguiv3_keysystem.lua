...
TextButton.MouseButton1Click:Connect(function()
	if KeyTextbox.Text == key then
		...
		task.wait(3)
		print("Script") -- insert script on this line
		ScreenGui:Destroy()
	else
...
madeby.Text = "Made by: 007n7scripter" .. whoisitmadeby
